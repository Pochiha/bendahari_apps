...
//Controller Path
namespace App\Http\Controllers\UKM\Modules\Dashboard\Intern\Authorization;
...
class LoginController extends Controller{
  ...
  **************************************************************************************/
  public function routePath(){
    ...
    //Set View
    $this->route_link['view'] = config('routing.ukm.modules.dashboard.view').'.intern.';

    //Set Path
    $this->route_link['name'] = config('routing.ukm.modules.dashboard.name').'.intern.';

		//Set Image Route
		$this->asset['images'] = '/images/ukm/modules/dashboard/intern/authorization/login/';
  ...
  **************************************************************************************/
  public function login(){
    ...
    $authorization_token['guard'] = $token->encrypt['guard']['intern'];
