...
//Get Controller Path
namespace App\Http\Controllers\UKM\Modules\Dashboard\Intern\Home;
...
class IndexController extends Controller{
	...
	**************************************************************************************/
	public function routePath(){
		...
		//Set Route View
		$this->route_link['view'] = config('routing.ukm.modules.dashboard.intern.view').'.';

		//Set Path
		$this->route_link['name'] = config('routing.ukm.modules.dashboard.intern.view').'.';
		...
		$hyperlink['navigation']['header']['authorization']['intern'] = config('routing.ukm.modules.dashboard.intern.view.name').'.authorization.intern.login.ukm';
