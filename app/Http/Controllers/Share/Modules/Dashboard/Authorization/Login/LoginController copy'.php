...
//Controller Path
namespace App\Http\Controllers\IUKL\Modules\Dashboard\Employee\Authorization;
...
class LoginController extends Controller{
  ...
  **************************************************************************************/
  public function routePath(){
    ...
    //Set View
    $this->route_link['view'] = config('routing.iukl.modules.dashboard.view').'.employee.';

    //Set Path
    $this->route_link['name'] = config('routing.iukl.modules.dashboard.name').'.employee.';

		//Set Image Route
		$this->asset['images'] = '/images/iukl/modules/dashboard/employee/authorization/login/';

    //Set Hyperlink
    $this->hyperlink['page']['login'] = $this->route_link['name'].'login';
    $this->hyperlink['page']['process'] = config('routing.share.modules.dashboard.name').'.employee.authorization.process.login';
  ...
  **************************************************************************************/
  public function login(){
    ...
    $authorization_token['database'] = $token->encrypt['database']['iukl'];
